...
describe('previewSkipReasonDeletion', () => {
  test('returns skip reason and parent role', () => {
    ...
    const sr = sqlite.prepare('SELECT * FROM skip_reasons WHERE role_id = ?').get(roleId) as {
      id: number;
    };

    const preview = previewSkipReasonDeletion(sqlite, sr.id);
...
describe('deleteSkipReason', () => {
  test('deletes skip reason by id', () => {
    ...
    deleteSkipReason(sqlite, sr.id);

    const result = sqlite.prepare('SELECT * FROM skip_reasons WHERE id = ?').get(sr.id);
  ...
  test('returns deleted reason and parent role', () => {
    ...
    const result = deleteSkipReason(sqlite, sr.id);
...
describe('previewTerminationReasonDeletion', () => {
  test('returns termination reason and parent role', () => {
    ...
    const preview = previewTerminationReasonDeletion(sqlite, tr.id);
...
describe('deleteTerminationReason', () => {
  test('deletes termination reason by id', () => {
    ...
    deleteTerminationReason(sqlite, tr.id);

    const result = sqlite.prepare('SELECT * FROM termination_reasons WHERE id = ?').get(tr.id);
    expect(result).toBeUndefined();
  });
  ...
  test('returns deleted reason and parent role', () => {
    ...
    const result = deleteTerminationReason(sqlite, tr.id);
