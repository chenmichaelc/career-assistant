...
export function insertJobDescription(db: Database.Database, roleId: number, content: string): number {
...
export function getJobDescriptionByRoleId(db: Database.Database, roleId: number): JobDescriptionRow | undefined {
    return db.prepare(`
...
export function deleteJobDescriptionByRoleId(db: Database.Database, roleId: number): Database.RunResult {
